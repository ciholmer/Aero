...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		println "Getting Spring conext ..."
		// Get spring context
		def springContext = WebApplicationContextUtils.getWebApplicationContext( servletContext )
		println "Registering Custom Object Marshaller ..."
		...
		println "current envrioment: $Environment.current"
		println "$result"
				
    }
	
    def destroy = {
		println "Application sutting down..."
    }
