		...
		<div id="show-city" class="content scaffold-show" role="main">
			...
			<ol class="property-list city">
				...
				<li class="fieldcontain">
					<span id="postalCode-label" class="property-label"><g:message code="city.postalCode.label" default="Postal Code" /></span>
					
						<span class="property-value" aria-labelledby="postalCode-label"><g:fieldValue bean="${cityInstance}" field="postalCode"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${cityInstance?.stateName}">
				<li class="fieldcontain">
					<span id="stateName-label" class="property-label"><g:message code="city.stateName.label" default="State Name" /></span>
					
						<span class="property-value" aria-labelledby="stateName-label"><g:fieldValue bean="${cityInstance}" field="stateName"/></span>
